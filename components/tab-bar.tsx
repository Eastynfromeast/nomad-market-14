...
export default function TabBar() {
	...
	return (
		<div className=" fixed bottom-0 w-full mx-auto max-w-screen-sm grid grid-cols-5 border-neutal-600 border-t px-5 py-3 *:flex *:flex-col *:justify-center *:items-center *:gap-px *:text-white ">
			<Link href="/products">
